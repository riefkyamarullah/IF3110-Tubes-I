...
  					<option value=300001>Rp. 300.001,00 - Rp. 400.000,00</option>
		...
		<p id="textlogout">
				Welcome, <a href="HalamanProfil.php" target="_blank"> <?php echo $_COOKIE['username'] ?></a> !
		</p>
	...
	<div class="tempattombol"> 	
		...
		<div class="login"  >
			<a href="HomeA.php" target="_blank">
		...
		<div class="cart"  >
			<a href="HalamanShoppingBagB.php" target="_blank">
...
<div class="menu">
	...
	<div id="barang"> 
		<a href="HalamanBarang1B.php" target="_blank">Kategori 1<br><br>
		</a> 
	</div>
	
	<div id="barang"> 
		<a href="HalamanBarang2B.php" target="_blank">Kategori 2<br><br>
		</a> 
	</div>
	
	<div id="barang"> 
		<a href="HalamanBarang3B.php" target="_blank">Kategori 3<br><br>
		</a> 
	</div>
	
	<div id="barang"> 
		<a href="HalamanBarang4B.php" target="_blank">Kategori 4<br><br>
		</a> 
	</div>
	
	<div id="barang"> 
		<a href="HalamanBarang5B.php" target="_blank">Kategori 5<br><br>
		</a> 
	</div>
