...
<div class="content">
	<div class="test">
		<h2 align="center">Urutan Berdasarkan Nama : Kategori Teh</h2>
		...
		<div class="test2">
			...
			<?php
				...
				$order = "SELECT * FROM produk WHERE kategori ='Teh'  ORDER BY nama DESC";
...
<div class="test">
		<h2 align="center">Urutan Berdasarkan Harga : Kategori Teh</h2>
		...
		<div class="test2">
			...
			<?php
				...
				$order = "SELECT * FROM produk WHERE kategori ='Teh'  ORDER BY harga DESC";
				//order to search data
				//declare in the order variable
