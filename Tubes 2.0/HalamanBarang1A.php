...
<div class="menu">
	...
	<div id="barang"> Beras <br><br>
	</div>
	
	<div id="barang"> 
		<a href="HalamanBarang2A.php" target="">Daging<br><br>
		</a> 
	</div>
...
<div class="content">
	<div class="test">
		<h2 align="center">Urutan Berdasarkan Nama : Kategori Beras</h2>
		...
		<div class="test2">
			...
			<?php
				...
				$order = "SELECT * FROM produk WHERE kategori ='Beras'  ORDER BY nama DESC";
...
<div class="test">
		<h2 align="center">Urutan Berdasarkan Harga : Kategori Beras</h2>
		...
		<div class="test2">
			...
			<?php
				...
				$order = "SELECT * FROM produk WHERE kategori ='Beras'  ORDER BY harga DESC";
				//order to search data
				//declare in the order variable
