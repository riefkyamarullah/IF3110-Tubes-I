...
<div class="content">
	<div class="test">
		<h2 align="center">Urutan Berdasarkan Nama : Kategori Kopi</h2>
		...
		<div class="test2">
			...
			<?php
				...
				$order = "SELECT * FROM produk WHERE kategori ='Kopi'  ORDER BY nama DESC";
...
<div class="test">
		<h2 align="center">Urutan Berdasarkan Harga : Kategori Kopi</h2>
		...
		<div class="test2">
			...
			<?php
				...
				$order = "SELECT * FROM produk WHERE kategori ='Kopi'  ORDER BY harga DESC";
				//order to search data
				//declare in the order variable
